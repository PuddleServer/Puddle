...
```typescript
import { System, FileManager } from "https://github.com/PuddleServer/Puddle/raw/1.0.0beta/mod.ts"
...
```typescript
import { System, PuddleJSON } from "https://github.com/PuddleServer/Puddle/raw/1.0.0beta/mod.ts";
