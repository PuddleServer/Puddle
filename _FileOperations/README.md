...
```typescript
import { System, FileManager } from "https://github.com/PuddleServer/Puddle/raw/v1.1.2-beta/mod.ts"
...
```typescript
import { System, PuddleJSON } from "https://github.com/PuddleServer/Puddle/raw/v1.1.2-beta/mod.ts";
