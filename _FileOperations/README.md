...
```typescript
import { System, FileManager } from "https://github.com/PuddleServer/Puddle/raw/develop/mod.ts"
...
```typescript
import { System, PuddleJSON } from "https://github.com/PuddleServer/Puddle/raw/develop/mod.ts";
